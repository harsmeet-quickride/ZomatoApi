...
public class BindingUtils {
    ...
    public static void loadThumbnailImage(ImageView imageView, String url, String restaurantUrl) {
        ...
        Glide.with(imageView)
                .load(url)
                .apply(GlideModule.roundedCornerImage(new RequestOptions(), imageView.getContext(), 4))
    ...
    public static void loadImage(ImageView imageView, String url, String restaurantUrl) {
        ...
        Glide.with(imageView)
                .load(url)
                .apply(GlideModule.roundedCornerImage(new RequestOptions(), imageView.getContext(), 0))
                .placeholder(context.getResources().getDrawable(R.color.cardBackground))
                .into(imageView);
    ...
    public static void loadSourceImage(ImageView imageView, String sourceUrl) {
        ...
        Glide.with(imageView)
                .load(sourceUrl)
                .apply(GlideModule.roundedCornerImage(new RequestOptions(), context, 4))
                .placeholder(context.getResources().getDrawable(R.color.cardBackground))
                .into(imageView);
    }
    ...
    /**
     * Utility method for fetching formatted  Source Category and country
     *
